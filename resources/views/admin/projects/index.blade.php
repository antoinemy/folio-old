					...
					<div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        <div class="panel-heading">
	                        <div class="btn-group pull-right">
                                <a href="{{ route('project_new') }}" class="btn btn-success btn-xs">Nouveau projet</a>
                            </div>
                            <h4 class="panel-title">Tous les projets</h4>
                        </div>
                                    ...
                                    <tbody>
	                                    @foreach($publish as $p)
	                                        <tr>
	                                            ...
	                                            <td>
		                                            <form method="POST" action="{{ route('project_delete', $p->id) }}">
			                                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
			                                            <div class="btn-group text-center">
				                                            <a href="{{ route('project_edit', $p->id) }}" class="btn btn-white btn-xs"><span class="fa fa-edit"></span></a>
			...
			<div class="row">
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('project_update_page') }}" enctype="multipart/form-data">
	                            <input type="hidden" name="_token" value="{{ csrf_token() }}">
	                            ...
	                            <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                    	<div class="row">
		                                    ...
		                                    <div class="col-md-1">
		                                    	<img class="img-responsive" width="250px" src="{{ route('cover_image', ['projects', 100, 35]) }}"/>
		                                    </div>
                                    	</div>
                                    </div>
                                </div>
