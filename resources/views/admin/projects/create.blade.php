			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('project_store') }}" enctype="multipart/form-data">
	                            <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                    	<div class="row">
		                                    ...
		                                    <div class="col-md-10">
		                                        <input type="text" class="form-control" placeholder="Nom de l'image" name="background_image_name"/>
		                                    </div>
                                    	</div>
                                    </div>
                                </div>
	                            ...
	                            <div class="form-group">
							    	...
							    	<div class="col-md-11" id="start">
							        	<div class="row" id="startRow">
							                <div class="col-md-2">
							                    <span class="btn btn-white btn-file">
							                    	Télécharger une image <input name="image_0" type="file">
							                    </span>
							                </div>
							                <div class="col-md-9">
							                    <input type="text" class="form-control" placeholder="Nom de l'image" name="image_name_0"/>
							                </div>
							                <div class="col-md-1 text-right">
							                	<button type="button" class="btn btn-success plus"><span class="fa fa-plus"></span></button>
							                </div>
							        	</div>
							    	</div>
								</div>
	...
	<script>
		...
		$(document).ready(function() {
			...
			$(document).on('click', '.plus',function() {
				if(i <= 4) {
					$('#startRow').after('<div class="row m-t-15" id="startRow"><div class="col-md-2"><span class="btn btn-white btn-file">Télécharger une image <input name="image_'+i+'" type="file"></span></div><div class="col-md-9"><input type="text" class="form-control" placeholder="Nom de l\'image" name="image_name_'+i+'"/></div><div class="col-md-1 text-right"><button type="button" class="btn btn-success plus"><span class="fa fa-plus"></span></button></div></div>');
				}
				else if(i == 5) {
					$('#startRow').after('<div class="row m-t-15" id="startRow"><div class="col-md-2"><span class="btn btn-white btn-file">Télécharger une image <input name="image_'+i+'" type="file"></span></div><div class="col-md-9"><input type="text" class="form-control" placeholder="Nom de l\'image" name="image_name_'+i+'"/></div><div class="col-md-1 text-right"></div></div>');
				}
				$('.plus').first().remove();
				i++;
			});
