			    ...
			    <div class="col-md-12">
                    ...
                    <div class="panel panel-inverse" data-sortable-id="form-stuff-1">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('sitemap_admin_update') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-11">
                                    	<div class="row">
		                                    ...
		                                    <div class="col-md-1">
		                                    	<img class="img-responsive" width="250px" src="{{ route('cover_image', ['sitemap', 100, 35]) }}"/>
		                                    </div>
                                    	</div>
                                    </div>
                                </div>
